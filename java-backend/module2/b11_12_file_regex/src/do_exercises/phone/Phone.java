...
public abstract class Phone implements Comparable<Phone> {
    ...
    public String toCSV() {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        String warrantyDateStr = warrantyPeriod != null ? warrantyPeriod.format(formatter) : "";

        return String.format("%s,%s,%s,%s,%s,%s,",id, name, price, warrantyDateStr, osPhone, manufacturer);
    }
